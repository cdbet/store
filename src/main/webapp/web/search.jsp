...
<body>
						...
						<div class="info">
							<div class="img pic">
								<img src="..${goods.image}" alt="${goods.title}"
									onclick="toItemInfo(${goods.id},${goods.categoryId})" />
							</div>
							<div class="describe">
								<p onclick="toItemInfo(${goods.id},${goods.categoryId})"style="width:220px;height: 14px;overflow:hidden;">${goods.title}</p>
								...
								<span class="addCart"><img id="collect"
									...
									href="javascript:void(0);" class="add_cart" onclick="addCartFun(${goods.id})">加入购物车</a></span>
	...
	function toItemInfo(id,categoryId) {
		if (id) {
			window.location.href="../goods/showDetails.do?id="+id+"&categoryId="+categoryId;
		}else {
			alert("商品id不存在");
		}
	} 
