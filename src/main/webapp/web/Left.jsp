...
<div id="leftsidebar_box" class="lf">
	...
	<dl class="my_order">
		<dt>
			我的订单 <img src="${pageContext.request.contextPath}/images/myOrder/myOrder2.png">
		</dt>
		<dd class="first_dd">
	...
	<dl class="address">
		...
		<dd>
			<a href="../address/showAddress.do">地址管理</a>
		</dd>
	</dl>
	<dl class="count_managment">
		...
		<dd class="first_dd">
			<a href="${pageContext.request.contextPath}/user/showPersonInfo.do">我的信息</a>
		</dd>
		<dd>
			<a href="${pageContext.request.contextPath}/user/showPassword.do">安全管理</a>
		</dd>
	</dl>
</div>