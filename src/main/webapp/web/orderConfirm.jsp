...
<div id="container" class="clear">
    ...
    <form name="" method="post" action="#">
        <div class="product_confirm">
            ...
            <c:forEach items="${listOrder}" var="cartVo">
            <ul class="item_detail">
                <li class="p_info">
                    <b><img src="..${cartVo.image}" style="width: 84px;height: 84px;"/></b>
                ...
                <li class="p_price">
                    <i>达内专属价</i>
                    <br/>
                    <span class="pro_price">￥<span class="ppp_price">${cartVo.price}.00</span></span>
                </li>
                <li class="p_count">X<span>${cartVo.num}</span></li>
