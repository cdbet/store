...
<body>
	...
	<div class="lf1">
		<div class="lf1_top">
			...
			<div class="left lf">
				...
				<span><img
					src="${pageContext.request.contextPath}/images/itemCat/study_computer_img1.png"
					alt="" /></span>
			</div>
			<!-- 上面部分右侧区域-->
			<div class="right lf">
				...
				<span><img
					src="${pageContext.request.contextPath}/images/itemCat/study_computer_img2.png"
					alt="" /></span>
			</div>
		</div>
		<div class="lf1_bottom">
			<div class="item_cat lf">
				...
				<div class="item_cat_all">
					...
					<c:forEach items="${list2}" varStatus="abc">
						<p>${list2[abc.index].name}</p>
						<ul>
							<c:forEach items="${list3[abc.index]}" var="category">
								<li><a href="${pageContext.request.contextPath}/goods/showSearch.do?categoryId=${category.id}">${category.name}</a></li>
			...
			<div class="item_msg lf">
				<img
					src="..${goods.image}" style="width: 198px;height: 136px;" alt="" />
	...
	<h2 id="stationery" class="stair">
		<span><img
			src="${pageContext.request.contextPath}/images/itemCat/stationery_icon.png"
		...
		<div class="lf1_top">
			...
			<div class="left lf">
				<div class="left_ys1 lf">
					<img
						src="${pageContext.request.contextPath}/images/itemCat/study_stationery_img1.png"
						alt="" />
				</div>
				<div class="left_pro lf">
			...
			<div class="right lf">
				<div class="left_ys2 lf">
					<img
						src="${pageContext.request.contextPath}/images/itemCat/study_stationery_img2.png"
						alt="" />
				</div>
		...
		<div class="lf1_bottom">
			<div class="item_cat lf">
				<div class="cat_header color_1">
					<span> <img
						src="${pageContext.request.contextPath}/images/itemCat/stationery_icon1.png"
						alt="" /> 办公文具/2F
					</span>
				</div>
			...
			<div class="item_msg lf">
				<img
					src="${pageContext.request.contextPath}/images/itemCat/study_stationery_img3.png"
					alt="" />
			...
			<div class="item_msg lf">
				<img
					src="${pageContext.request.contextPath}/images/itemCat/study_stationery_img4.png"
					alt="" />
			...
			<div class="item_msg lf">
				<a href="product_details.html"> <img
					src="${pageContext.request.contextPath}/images/itemCat/study_stationery_img5.png"
					alt="" />
