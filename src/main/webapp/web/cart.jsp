                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="${cartVo.id}">
                            <img src="..${cartVo.image}" class="lf" style="height: 70px"/>
                    ...
                    <div class="pices">
                        ...
                        <p class="pices_information"><b>￥</b><span>${cartVo.price}</span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${cartVo.num}" /><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${cartVo.price*cartVo.num}.00</span>
                    </div>
                    <div class="del">
                        <!-- <div>
