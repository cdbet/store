...
<div id="container" class="clearfix">
    ...
    <div class="rightsidebar_box rt">
      <jsp:include page="personInfoHeader.jsp"></jsp:include>
        ...
        <div class="rs_content">
            ...
            <div class="rs_content_headPortrait">
	                ...
	                <img alt="" src="${pageContext.request.contextPath}${user.image}" id="icon" width="50px"height="50px">
	                </c:if>
	                <c:if test="${user.image==null}">
	                <img src="${pageContext.request.contextPath}/images/personage/touxiang.png" alt="" id="icon" width="50px" height="50px"/>
	               </c:if>
	       
	                <input type="file" name="file" id="iconPic" onchange="getImageFun()">
            ...
            <!--保存按钮-->
            <div class="save" onclick="btnUpdateUser()">
                保存更改
            </div>
            </form>
        </div>
