...
public class Address implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9092301180931836711L;
	private Integer id;
	private Integer uid;
	...
	public Address(Integer id, Integer uid, String recvName, String recvProvince, String recvCity, String recvArea,
			String recvAddress, String recvDistric, String recvPhone, String recvTel, String recvZip, String recvTag,
	...
	public int hashCode() {
		...
		result = prime * result + ((recvDistric == null) ? 0 : recvDistric.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (recvCity == null) {
			...
			return false;
		if (recvDistric == null) {
			if (other.recvDistric != null)
				return false;
		} else if (!recvDistric.equals(other.recvDistric))
			return false;
		if (recvName == null) {
	...
	public String toString() {
		return "Address [id=" + id + ", uid=" + uid + ", recvName=" + recvName + ", recvProvince=" + recvProvince
				...
				+ ", recvDistric=" + recvDistric + ", recvPhone=" + recvPhone + ", recvTel=" + recvTel + ", recvZip="
				+ recvZip + ", recvTag=" + recvTag + ", isDefault=" + isDefault + ", createdUser=" + createdUser
